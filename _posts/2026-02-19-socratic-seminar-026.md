...
meetup: https://app.evento.so/e/evt_pknqkJzVntf3xTRQ
---
...
### Aquecimento
* BTC++ semana que vem
* [`glozow` steps down from Core maintainership](https://github.com/bitcoin/bitcoin/pull/34517)
* [Pieter Wuille não quer mais estar envolvido em mudanças de consenso](https://x.com/isabelfoxenduke/status/2021680963726475362?s=20)
  * [Episódio completo](https://x.com/isabelfoxenduke/status/2021618798919377155)
* [$1,000,000 was settled over the Lightning Network](https://x.com/voltage_cloud/status/2019402303032209818)

### Bitcoin L1
* [BIP 360 merged: Pay-to-Merkle-Root (P2MR) for quantum-resistant outputs](https://github.com/bitcoin/bips/pull/1670)
    * [Discussion on post-quantum migration and BIP 360 updates](https://groups.google.com/g/bitcoindev/c/some-thread-on-BIP360)

### Lightning and L2
* [Citrea Mainnet goes live](https://www.blog.citrea.xyz/citrea-mainnet-is-live/)
